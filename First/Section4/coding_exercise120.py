...
print(isinstance(var1, tuple))   # False
print(isinstance(var2, tuple))   # False
print(isinstance(var3, tuple))   # True
print(isinstance(var4, tuple))   # False
print(isinstance(var5, tuple))   # False
